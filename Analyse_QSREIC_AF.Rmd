...
#### LEGENDE : avec nouvelles sous-échelles aprés AF
...
data_6$Q14___QSREIC_4 <- recode(data_6$Q14___QSREIC_4, "1=5; 2=4; 3=3;4=2; 5=1")
data_6$Q14___QSREIC_23 <- recode(data_6$Q14___QSREIC_23, "1=5; 2=4; 3=3;4=2; 5=1")

data_6$Q14___QSREIC_21 <- recode(data_6$Q14___QSREIC_21, "1=5; 2=4; 3=3;4=2; 5=1")
data_6$Q14___QSREIC_24 <- recode(data_6$Q14___QSREIC_24, "1=5; 2=4; 3=3;4=2; 5=1")

data_6$QSREIC_comparaison <- data_6$Q14___QSREIC_4 + data_6$Q14___QSREIC_5 + data_6$Q14___QSREIC_10 + data_6$Q14___QSREIC_16 + data_6$Q14___QSREIC_18 + data_6$Q14___QSREIC_19 + data_6$Q14___QSREIC_23

data_6$QSREIC_reevaluation <- data_6$Q14___QSREIC_3 + data_6$Q14___QSREIC_7 + data_6$Q14___QSREIC_8 

data_6$QSREIC_evitement <- data_6$Q14___QSREIC_15 + data_6$Q14___QSREIC_20 + data_6$Q14___QSREIC_27 

data_6$QSREIC_rumination <- data_6$Q14___QSREIC_22 + data_6$Q14___QSREIC_26  

data_6$QSREIC_defense <- data_6$Q14___QSREIC_21 + data_6$Q14___QSREIC_24 




data_6$CERQ_ADA <-  data_6$QSREIC_comparaison + data_6$QSREIC_reevaluation 

data_6$CERQ_MAL <-  data_6$QSREIC_evitement +  data_6$QSREIC_rumination + data_6$QSREIC_defense
...
QSREIC_alpha<- QSREIC_alpha[,-c(1,2,6,9,11,12,13,14,25,17)]
...
QSREIC_comparaison <-subset(data_6, select = c( Q14___QSREIC_4 ,  Q14___QSREIC_5 ,  Q14___QSREIC_10, Q14___QSREIC_16, Q14___QSREIC_18, Q14___QSREIC_19, Q14___QSREIC_23))
alpha(QSREIC_comparaison)

QSREIC_reevaluation  <-subset(data_6, select = c( Q14___QSREIC_3 ,  Q14___QSREIC_7 ,  Q14___QSREIC_8))
alpha(QSREIC_reevaluation)

QSREIC_evitement <-subset(data_6, select = c( Q14___QSREIC_15 ,  Q14___QSREIC_20 ,  Q14___QSREIC_27))
alpha(QSREIC_evitement)

QSREIC_rumination  <-subset(data_6, select = c( Q14___QSREIC_22 ,  Q14___QSREIC_26))
alpha(QSREIC_rumination)

QSREIC_defense  <-subset(data_6, select = c( Q14___QSREIC_21 ,  Q14___QSREIC_24))
alpha(QSREIC_defense)



QSREIC_ADA <-subset(data_6, select = c( Q14___QSREIC_4 ,  Q14___QSREIC_5 ,  Q14___QSREIC_10, Q14___QSREIC_16, Q14___QSREIC_18, Q14___QSREIC_19, Q14___QSREIC_23, Q14___QSREIC_3 ,  Q14___QSREIC_7 ,  Q14___QSREIC_8))

alpha(QSREIC_ADA)

QSREIC_MAL <-subset(data_6, select = c( Q14___QSREIC_15 ,  Q14___QSREIC_20 ,  Q14___QSREIC_27, Q14___QSREIC_22 ,  Q14___QSREIC_26, Q14___QSREIC_21 ,  Q14___QSREIC_24))
...
ACP_1 <-  principal(QSREIC_alpha, nfactors = 17, rotate = "none", scores = FALSE)
ACP_1
