---
title: "Analyse_2facteurs_stat_genre"
...
#### LEGENDE : attention juste ok pour stat descriptives !!!
...
```{r stat descriptive, include=FALSE}
...
data_9 <- data_merge[ , -c(2:19)]
data_9 <- data_9[ , 1:24]

summary(data_9,  na.rm = TRUE)

names(data_9)[names(data_9) == "Q15"] <- "age"
names(data_9)[names(data_9) == "Q17_1"] <- "homme"
names(data_9)[names(data_9) == "Q17_4"] <- "femme"
names(data_9)[names(data_9) == "Q17_2"] <- "fluctuant"
names(data_9)[names(data_9) == "Q17_3"] <- "nonconf"
names(data_9)[names(data_9) == "Q17_5"] <- "nonbin"
names(data_9)[names(data_9) == "Q19"] <- "niv scol"

write.csv2(data_9, "data_9.csv")
...
data_7 <- merge(csv_2, data_6, by=c("ResponseId"))
...
#vérif ok
#write.csv2(data_8, "data_8_quest.csv")
