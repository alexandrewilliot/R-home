---
title: "Analyse_2facteurs_select_2_H"
...
#### LEGENDE : aprés avoir retiré les items présents aux 2 facteurs et adapté alpha mal et ada selon analyse factorielle ## Résultats VALIDES QUE POUR ALPHA MAL ET ADA ET AF !
...
#Colonne 21 pour genre H
#data_4b<-data_4[,c(6,21,23:145)]


data_5 <- data_4[ , 6:145]
data_5<-data_5[,-c(5:15,17:37)] # conserve colonne homme

# 107 variables
data_6 <- na.omit(data_5) # Supprime toutes les lignes avec des NA #n=578 # donc garde les hommes n=166
...
#inversion basée sur AF 'précédente'
#data_6$Q14___QSREIC_16 <- recode(data_6$Q14___QSREIC_16, "1=5; 2=4; 3=3;4=2; 5=1")
#data_6$Q14___QSREIC_10 <- recode(data_6$Q14___QSREIC_10, "1=5; 2=4; 3=3;4=2; 5=1")
#data_6$Q14___QSREIC_18 <- recode(data_6$Q14___QSREIC_18, "1=5; 2=4; 3=3;4=2; 5=1")
...
#supp items qui corrélent aux 2 dim 9,17,25
QSREIC_alpha<- QSREIC_alpha[,-c(9,17,25,10,18,16,8)]
...
QSREIC_dram <-subset(data_6, select = c( Q14___QSREIC_1 ,   Q14___QSREIC_14))
alpha(QSREIC_dram)

QSREIC_planif <-subset(data_6, select = c( Q14___QSREIC_2 ,  Q14___QSREIC_11 ,  Q14___QSREIC_12 ))
alpha(QSREIC_planif)
...
# supp 9,17,25,10,18,16,8

QSREIC_ADA <-subset(data_6, select = c( Q14___QSREIC_2 ,  Q14___QSREIC_11 ,  Q14___QSREIC_12 , Q14___QSREIC_3 ,  Q14___QSREIC_7 ,   Q14___QSREIC_21, Q14___QSREIC_24))
alpha(QSREIC_ADA)

#déplacement de ADA vers MAL selon AF: 5, 19, 26, 16 (sup)
QSREIC_MAL <-subset(data_6, select = c( Q14___QSREIC_5 , Q14___QSREIC_19, Q14___QSREIC_26, Q14___QSREIC_1 ,  Q14___QSREIC_14 ,  Q14___QSREIC_23 ,  Q14___QSREIC_4, Q14___QSREIC_6 ,  Q14___QSREIC_13, Q14___QSREIC_22, Q14___QSREIC_27 ,  Q14___QSREIC_20, Q14___QSREIC_15))
alpha(QSREIC_MAL)
...
ACP_1 <-  principal(QSREIC_alpha, nfactors = 20, rotate = "none", scores = FALSE)
ACP_1
